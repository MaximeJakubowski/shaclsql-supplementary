...
class Exercise1(Exercise):
    ...
    def __init__(self, file: FileIO, number_of_humans: int, number_of_objects: int, probability_of_phone_number: int,
                 probability_of_email: int, range_of_phone_numbers: tuple[int, int], range_of_emails: tuple[int, int], start_humanid=0, start_objects=0):
        """
        Constructor
        :type file: FileIO
        ...
        self.__start_objectid = start_objects
    ...
    def gen_ex(self) -> None:
        ...
        for human in range(self.__start_humanid, self.__start_humanid + self.__number_of_humans):
            my_subject: str = super()._gen_human(1, human)
